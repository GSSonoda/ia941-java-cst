...
public class GoToClosestJewel extends Codelet {
	...
	private double minimumFuel;

	public GoToClosestJewel(int creatureBasicSpeed, int reachDistance, int minimumFuel) {
	...
	public void proc() {
		...
		if(closestJewel != null)
		{
			...
			double selfFuel=(double)cis.get("fuel").getValue();
			...
			try {
				if(distance>reachDistance && selfFuel >= this.minimumFuel){ //Go to it
