...
public class GoToClosestApple extends Codelet {
	...
	public GoToClosestApple(int creatureBasicSpeed, int reachDistance, int minimumFuel) {
	...
	public void proc() {
		...
		if(closestApple != null)
		{
			...
			try {
				if(distance>reachDistance && fuel < this.minimumFuel){ //Go to it
